...
export async function researcher(
  ...
  const openai = new Google({
    baseUrl: process.env.GOOGLE_API_BASE, // optional base URL for proxies etc.
    apiKey: process.env.GOOGLE_API_KEY, // optional API key, default to env property OPENAI_API_KEY
